...
def create_app():
    #load_dotenv("DOTENV_PATH", override=True)  # This will force reload env vars
    app = Quart(__name__)
...
async def send_chat_request(request_body, request_headers):
    ...
    try:
        ...
        #print("azure_openai_client : ", azure_openai_client ,azure_openai_client.chat.completions.create(**model_args))
...
async def delete_conversation():
    #request_json = await request.get_json()
    # print(request_json.get("conversation_id", None))
    await cosmos_db_ready.wait()
